...
{
    // Expanded to 10 patterns covering Lesson1 hardened set + common LLM injection markers
    private const PATTERNS = [
        ...
        // LLaMA / Mistral instruction-marker injection (e.g. [[INST]] ... [[/INST]])
        '/\[{1,2}\/?\s*INST\s*\]{1,2}/i',
        // Direct prompt/instruction reveal attempts
